...
<body>
	...
	<!-- End Approval Modal -->
	<?php 
		$sql = "SELECT * FROM encashment WHERE status='Approved' ORDER BY id DESC";
		...
		<table class="ta">
			...
			<tbody id="data_table">
				<tr>
					...
					<td data-label = "Approved" style="color: #2c578f;"><?php echo date('M  j, o | g:i A', strtotime($row["date_approve"])); ?></td>
