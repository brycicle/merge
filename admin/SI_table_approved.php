...
<body>
  <?php 
    ...
    $sql = "SELECT * FROM si_request WHERE status='Approved' ORDER BY id DESC";
  ...
  <div class="table-container">
    ...
    <tbody id="data_table">
      <tr>
        ...
        <td data-label = "Date" style="color: #2c578f;"><?php echo date('M  j, o | g:i A', strtotime($row["a_date"])); ?></td>
