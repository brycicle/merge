	...
	<div class="cl">
	    ...
	    <?php if(isset($referralLink)) { ?>
	        ...
	        <div class="input-group mb-3">
			  	<input type="text" class="form-control" value="<?php echo $referralLink; ?>" id="referral-link" aria-label="Recipient's username" aria-describedby="button-addon2" readonly>
			  	<button class="btn btn-primary" id="button-addon2" onclick="copyToClipboard()">Copy</button>
			</div>
	    <?php } ?>
	</div>
