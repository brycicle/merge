            	...
            	<div class="mdc-layout-grid__inner">
					...
					?>
              		...
              		<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
					    ...
					    $sql = mysqli_query($conn, "SELECT groupid FROM genealogy WHERE groupid='$accountid' AND usertype='user'");
              		...
              		<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
                		<div class="mdc-card info-card info-card--primary">
                  			<div class="card-inner">
                    			...
                    			<?php
                      $username = $_SESSION['username'];
                      $sql = mysqli_query($conn, "SELECT status FROM si_request WHERE status='Approved' AND limitedadminid=''");
                  ...
                  ?>
              		...
              		<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
					    ...
					    $username = $_SESSION['username'];
					    $accountid = $_GET['accountid'];
					    $sql = mysqli_query($conn, "SELECT SUM(payin) AS total_payin FROM genealogy WHERE groupid='$accountid' AND usertype='user'");
					    
					    $row = mysqli_fetch_assoc($sql);
					    $totalPayin = $row['total_payin'];

					    echo "<h5 class='border-bottom'>&#8369;".number_format($totalPayin,2)."</h5>";
					?>
              		...
              		<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
                		<div class="mdc-card info-card info-card--success">
                  			<div class="card-inner">
                    			...
                    			<?php
                    $username = $_SESSION['username'];
                    $sql = mysqli_query($conn, "SELECT SUM(si_payment) AS total_si_payment FROM si_request WHERE limitedadminid=''");
              		...
              		<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
                		<div class="mdc-card info-card info-card--success">
                  			<div class="card-inner">
								...
								echo '<h5 class="border-bottom">&#8369;'.number_format($tax,2) .'</h5>';
