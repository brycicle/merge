                            ...
                            for ($d = 0; $d < $divide; $d++) {
                                ...
                                if (!empty($currentId[$d])) {
                                    ...
                                    if ($levelCounter == 0) {
                                        ...
                                        ?>
                                        <li class="lock-item">
                                            <a style="margin-right: 160px; margin-left: 160px;"><img
                                                        src="../userlock.png"><span class="spacer">      <b>Lock</b>      </span></a>
                                        </li>
                                        <?php
                                    } elseif ($levelCounter == 2) {
                                        if ($level2 == 0) {
                                            ?>
                                            <li class="lock-item">
                                                <a style="margin-right: 70px; margin-left: 40px;"><img
                                                            src="../userlock.png"><span class="spacer">      <b>Lock</b>      </span></a>
                                            </li>
                                            <?php
                                            $level2++;
                                            ...
                                            ?>
                                            <li class="lock-item">
                                                <a style="margin-right: 65px; margin-left:40px;"><img
                                                            src="../userlock.png"><span class="spacer">      <b>Lock</b>      </span></a>
                                            </li>
                                            <?php
                                            $level2++;
                                            ...
                                            ?>
                                            <li class="lock-item">
                                                <a style="margin-right: 40px; margin-left:65px;"><img
                                                            src="../userlock.png"><span class="spacer">      <b>Lock</b>      </span></a>
                                            </li>
                                            <?php
                                            $level2++;
                                            ...
                                            ?>
                                            <li class="lock-item">
                                                <a style="margin-right: 40px; margin-left: 70px;"><img
                                                            src="../userlock.png"><span class="spacer">      <b>Lock</b>      </span></a>
                                            </li>
                                            <?php
                                            $level2++;
                                ...
                                for ($side = 0; $side < 2; $side++) {
                                    $temp_id[$temp_id_index] = !empty($currentId[$d]) ? fetch_left_right($side, $print_id) : null;
                                    $temp_id_index++;
                                }
                            }
